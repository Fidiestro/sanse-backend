...
exports.getAvailableProducts = async (req, res) => {
    try {
        // Productos hardcodeados por ahora (podrían venir de una tabla en el futuro)
        const products = [
            {
                id: 'sdtc_6m',
                name: 'Inversión SDTC',
...
exports.getMyInvestments = async (req, res) => {
    try {
        ...
        // Para cada inversión activa SDTC, traer rendimientos
